                ...
                <div class="card card-stats mb-4 mb-xl-0">
                  <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-auto">
                        <div class="icon">
                          <i class="material-icons" style="font-size: 30px ; color: green">bar_chart</i>
                        </div>
                      </div>
                    </div>
              ...
              <div class="col-xl-3 col-lg-6">
                <div class="card card-stats mb-4 mb-xl-0">
                  <div class="card-body">
                    ...
                    <p class="mt-3 mb-0 text-muted text-sm " >
                      <span class=" mr-2 " style="color: blue" ><i class="fas fa-arrow-up" style="color: blue"></i> 12%</span>
                      <span class="text-nowrap">Since last month</span>
                    </p>
                  </div>
                </div>
